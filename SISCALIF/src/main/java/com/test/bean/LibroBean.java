...
public class LibroBean {
    ...
    public String listarLibroSelect(){
        StringBuilder salidaTabla=new StringBuilder();
        StringBuilder query=new StringBuilder();
        query.append(" select * from libro ");
        try {
    ...
    public PreparedStatement getInsertLibro() {
        return insertLibro;
    }

    public void setInsertLibro(PreparedStatement insertLibro) {
        this.insertLibro = insertLibro;
    }
