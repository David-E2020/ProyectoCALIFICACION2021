        ...
        <form method="POST">
            <table border="1">
                ...
                <tbody>
                    <tr>
                        <td>CODIGO EST.:</td>
                        <td><input type="text" name="coEst" value="<%=estudiante.getEstudianteModificar().getCodEstudiante()%>" /></td>
                    </tr>
                    <tr>
                        <td>NOMBRE:</td>
                    ...
                    <tr>
                        <td>APELLIDOS:</td>
                        <td><input type="text" name="apEst" value="<%=estudiante.getEstudianteModificar().getApEstudiante()%>" /></td>
                    </tr>
                    <tr>
                        <td>CEDULA DE IDENTIDAD:</td>
                        <td><input type="text" name="ciEst" value="<%=estudiante.getEstudianteModificar().getCiEstudiante()%>" /></td>
                    </tr>
                    <tr>
                        <td> id GRADO:</td>
                        <td><input type="text" name="id_grado" value="<%=estudiante.getEstudianteModificar().getIdGrado()%>"/></td>
                    </tr>
                    <tr>
                        <td>GRADO:</td>
                        <td><input type="text" value="<%=estudiante.getEstudianteModificar().getNomGrado()%>" disabled/></td>
                        <td>
                            <select name="codG">
                    ...
                    <tr>
                        <td> id CURSO:</td>
                        <td><input type="text" name="id_curso" value="<%=estudiante.getEstudianteModificar().getIdCurso()%>" /></td>
                        
                    </tr>
                    <tr>
                        <td>CURSO:</td>
                        <td><input type="text" value="<%=estudiante.getEstudianteModificar().getNomCurso()%>" disabled/></td>
                        <td>
                            <select name="codC">
                                <option value="">SELECCIONE</option>
